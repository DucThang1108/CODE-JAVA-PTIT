...
public class bangDiemTheoLop {
    ...
    private static class BangDiem implements Comparable<BangDiem>{
        ...
        public String toString(){
            ...
            return this.sv.maSV+' '+this.sv.tenSV+' '+this.mh.maMH+' '
                    +this.mh.tenMH+' '+diem;
        }
        @Override
        public int compareTo(BangDiem o) {
            if(this.mh.maMH.contentEquals(o.mh.maMH))
                return this.sv.maSV.compareTo(o.sv.maSV);
            return this.mh.maMH.compareTo(o.mh.maMH);
        }
    }
